...
#all the explanation of the syntax used here are in pandasbasics.py
...
class DataCleaner:
    ...
    def filter_data(self):
        ...
        print("poor sleep and high stress:", stress_and_sleep.shape[0])
...
#if i wanna work on this data set again i should rewrite all the code 
